...
const targetStr1 = `  "dynamic-programming",\r\n] as const;`;
const targetStr2 = `  "dynamic-programming",\n] as const;`;
...
sidebarContent = sidebarContent.replace(targetStr1, replaceStr).replace(targetStr2, replaceStr);
