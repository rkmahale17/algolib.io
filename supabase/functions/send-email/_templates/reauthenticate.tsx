...
interface ReauthenticateEmailProps {
  supabase_url: string
  token_hash: string
  redirect_to: string
...
export const ReauthenticateEmail = ({
  supabase_url,
  token_hash,
  redirect_to,
  email_action_type,
}: ReauthenticateEmailProps) => {
  ...
  return (
    <Html lang="en">
      ...
      <Preview>Confirm your identity on RulCode</Preview>
            ...
            <Section style={{ padding: '40px' }}>
              ...
              <Section>
                <Text className="text-force-grey" style={textStyle}>
                  To protect your account, we need you to re-authenticate before performing this sensitive action. Please click the button below to confirm your identity.
                </Text>
              </Section>
...
export default ReauthenticateEmail
