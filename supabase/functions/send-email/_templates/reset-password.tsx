...
export const ResetPasswordEmail = ({
  ...
  return (
    <Html lang="en">
      ...
      <Preview>Reset your RulCode password</Preview>
            ...
            <Section style={{ padding: '40px' }}>
              ...
              <Section>
                <Text className="text-force-grey" style={textStyle}>
                  We received a request to reset your password. If this was you, click the button below to choose a new one.
                </Text>
                <Text className="text-force-grey" style={textStyle}>
              ...
              <Section style={{ marginTop: '40px' }}>
                <Link className="cta-button" href={resetUrl} style={buttonStyle}>
                  Reset My Password
                </Link>
              </Section>
