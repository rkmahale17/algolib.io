...
const blind75Map: Record<string, React.LazyExoticComponent<React.ComponentType<any>>> = {
  ...
  "non-overlapping-intervals": React.lazy(() => import("@/components/visualizations/algorithms/ActivitySelectionVisualization").then(m => ({ default: m.ActivitySelectionVisualization }))),
  ...
  "balanced-binary-tree": React.lazy(() => import("@/components/visualizations/algorithms/BalancedBinaryTreeVisualization").then(m => ({ default: m.BalancedBinaryTreeVisualization }))),
  ...
  'binary-tree-right-side-view': React.lazy(() => import('@/components/visualizations/algorithms/BinaryTreeRightSideViewVisualization').then(m => ({ default: m.BinaryTreeRightSideViewVisualization }))),
