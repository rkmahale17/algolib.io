            ...
            <div className="mt-8 flex justify-center">
                ...
                >
                    <div className="flex gap-1">
                        <span className="w-1.5 h-1.5 rounded-full bg-[#EAFF96] animate-pulse"></span>
                        <span className="w-1.5 h-1.5 rounded-full bg-[#EAFF96] animate-pulse [animation-delay:200ms]"></span>
                        <span className="w-1.5 h-1.5 rounded-full bg-[#EAFF96] animate-pulse [animation-delay:400ms]"></span>
                    </div>
