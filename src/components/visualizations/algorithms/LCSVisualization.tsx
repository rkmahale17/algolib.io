  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-card rounded-lg p-6 border overflow-x-auto">
        <h3 className="text-lg font-semibold mb-4">LCS: "{currentStep.text1}" vs "{currentStep.text2}"</h3>
      ...
      <VariablePanel
        variables={{
          i: currentStep.i,
          j: currentStep.j,
          lcsLength: currentStep.dp[currentStep.dp.length - 1][currentStep.dp[0].length - 1],
