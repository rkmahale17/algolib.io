      ...
      <div className="max-w-xl w-full bg-card/40 backdrop-blur-xl border border-primary/20 rounded-3xl p-8 md:p-12 shadow-2xl relative z-10 animate-in fade-in zoom-in duration-500">
        <div className="flex flex-col items-center text-center space-y-6">
          ...
          <div className="space-y-2">
            <h2 className="text-3xl md:text-4xl font- tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-primary via-primary/80 to-primary/60">
          ...
          <div className="w-full bg-primary/5 rounded-2xl p-6 border border-primary/10 space-y-4">
            <div className="flex justify-between items-center">
              <div className="text-left">
                ...
                <p className="text-2xl font-">$29.99<span className="text-sm text-muted-foreground font-normal">/year</span></p>
              </div>
              <div className="text-right">
                <span className="bg-primary/20 text-primary text-[10px] font- px-2 py-1 rounded-full uppercase">Save 40%</span>
              </div>
            </div>
            <Button
              className="w-full h-12 text-lg font- gap-2 group shadow-lg shadow-primary/20"
