          ...
          <div className="flex items-stretch border-b shrink-0">
            ...
            <TabsList className="flex-1 flex p-0 bg-transparent gap-0 rounded-none">
              <TooltipProvider>
                <TabsTrigger
                  value="code"
                  className="flex-1 data-[state=active]:bg-transparent data-[state=active]:text-foreground border-b-2 border-transparent data-[state=active]:border-primary rounded-none h-10"
                >
                  {isCompact ? (
                    <Tooltip>
