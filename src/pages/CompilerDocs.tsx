          ...
          <aside className={cn(
            ...
            <div className="flex flex-col h-full border-r md:border-none p-4 md:p-0">
              <div className="flex items-center justify-between mb-8 md:hidden">
                <span className="font-">Documentation</span>
          ...
          <main className="flex-1 min-w-0 space-y-24 max-w-4xl">
            ...
            <section id="overview" className="scroll-mt-24 space-y-6">
              <div className="space-y-4">
                <h1 className="text-4xl md:text-5xl font-extra tracking-tight">Code Runner Documentation</h1>
              ...
              <div className="grid sm:grid-cols-2 gap-4 pt-4">
                <div className="p-6 rounded-2xl bg-card border hover:shadow-md transition-shadow">
                  ...
                  <h3 className="text-lg font- mb-2">Isolated Sandbox</h3>
                ...
                <div className="p-6 rounded-2xl bg-card border hover:shadow-md transition-shadow">
                  ...
                  <h3 className="text-lg font- mb-2">Real-time Feedback</h3>
            ...
            <section id="infrastructure" className="scroll-mt-24 space-y-6">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-3xl font-">Execution Engine</h2>
              </div>
              ...
              <div className="bg-muted/30 border rounded-2xl p-6 space-y-4">
                ...
                <ol className="space-y-4 text-sm text-muted-foreground">
                  <li className="flex gap-4">
                    <span className="flex-none w-6 h-6 rounded-full bg-primary/10 text-primary flex items-center justify-center font-">1</span>
                    <span>Your code is wrapped in a specialized <strong>test harness</strong> that injects test cases and captures output.</span>
                  </li>
                  <li className="flex gap-4">
                    <span className="flex-none w-6 h-6 rounded-full bg-primary/10 text-primary flex items-center justify-center font-">2</span>
                    <span>The payload is transmitted via encrypted proxy to our execution nodes.</span>
                  </li>
                  <li className="flex gap-4">
                    <span className="flex-none w-6 h-6 rounded-full bg-primary/10 text-primary flex items-center justify-center font-">3</span>
                    <span>Code is compiled and executed in an <strong>unprivileged sandbox</strong> container.</span>
                  </li>
                  <li className="flex gap-4">
                    <span className="flex-none w-6 h-6 rounded-full bg-primary/10 text-primary flex items-center justify-center font-">4</span>
            ...
            <section id="compilers" className="scroll-mt-24 space-y-8">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-3xl font-">Compiler Matrix</h2>
              </div>
                ...
                {COMPILERS.map(comp => (
                  <div key={comp.name} className="p-6 rounded-2xl bg-card border hover:border-primary/50 transition-colors group">
                    <div className="flex items-center justify-between mb-4">
                      <h3 className="text-xl font-">{comp.name}</h3>
            ...
            <section id="limitations" className="scroll-mt-24 space-y-8">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="text-3xl font-">Resource Limitations</h2>
                </div>
                ...
                {LIMITATIONS.map(lim => (
                  <div key={lim.title} className="p-5 rounded-xl border bg-card hover:bg-muted/50 transition-colors space-y-3">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-xs font- font-mono px-2 py-0.5 rounded-full bg-muted border tracking-tighter">
                        {lim.limit}
                      </span>
                    </div>
                    <h4 className="font- text-sm">{lim.title}</h4>
            ...
            <section id="glossary" className="scroll-mt-24 space-y-8">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="text-3xl font-">Concept Glossary</h2>
                </div>
                  ...
                  {filteredGlossary.map((item) => (
                    ...
                    >
                      <div className="sm:w-48 shrink-0">
                        <Badge variant="secondary" className="mb-2 text-[10px] font- uppercase opacity-50">{item.category}</Badge>
                        <h4 className="font-extra text-foreground group-hover:text-primary transition-colors">{item.term}</h4>
                      </div>
