        ...
        <main className="container mx-auto px-4 py-8 max-w-4xl">
          <div className="space-y-8">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <p className="text-muted-foreground">
                  All payments on RulCode.com are processed by <strong>Lemon Squeezy</strong>, our Merchant of Record.
                  When you make a purchase, Lemon Squeezy collects and processes your payment information.
                </p>
                <p className="text-muted-foreground">
                  We do not store your credit card or full payment details on our servers. We only receive
                  confirmation of payment and basic transaction details necessary to provide you with access
                  to premium features.
                </p>
                <p className="text-muted-foreground">
                  Please review <a href="https://www.lemonsqueezy.com/privacy" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Lemon Squeezy's Privacy Policy</a> for
