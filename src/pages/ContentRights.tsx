  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:title" content="Content Rights & Usage Policy - RulCode" />
      ...
      <main className="min-h-screen bg-background">
        <div className="container mx-auto px-4 py-8 max-w-4xl">
          ...
          <div className="space-y-6">
            <Card>
              <CardHeader>
                <CardTitle>About RulCode</CardTitle>
              </CardHeader>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Original Additions by RulCode</CardTitle>
              </CardHeader>
              <CardContent className="prose prose-sm dark:prose-invert max-w-none">
                <p>Each embedded video is accompanied by:</p>
                <ul>
                  <li>Original explanations and breakdowns of the logic shown in the video.</li>
                  <li>Additional code examples, flow diagrams, or optimization notes created by RulCode.</li>
                  <li>Contextual commentary and learning notes that make the content distinct from the original video alone.</li>
                </ul>
                <p>
                  This ensures that every page on RulCode adds unique educational value beyond the embedded video.
                </p>
              </CardContent>
            </Card>
